...
void tb6612fng_set_mode(tb6612fng_e tb, tb6612fng_mode_e mode)
{
    ...
    case TB6612FNG_MODE_STOP:
        io_set_output(tb6612fng_cc_pins[tb].cc1, IO_OUT_LOW);
        io_set_output(tb6612fng_cc_pins[tb].cc2, IO_OUT_LOW);
        break;
    case TB6612FNG_MODE_FORWARD:
        io_set_output(tb6612fng_cc_pins[tb].cc1, IO_OUT_HIGH);
        io_set_output(tb6612fng_cc_pins[tb].cc2, IO_OUT_LOW);
        break;
    case TB6612FNG_MODE_REVERSE:
        io_set_output(tb6612fng_cc_pins[tb].cc1, IO_OUT_LOW);
        io_set_output(tb6612fng_cc_pins[tb].cc2, IO_OUT_HIGH);
        break;
    }
}
